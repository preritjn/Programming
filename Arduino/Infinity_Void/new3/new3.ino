...
void loop()
{
  ...
  else if (Ir1 == 1 && Ir2 == 1 && Ir3 == 0 && Ir4 == 0 && Ir5 == 0 && Ir6 == 0 && Ir7 == 1 && Ir8 == 1)
  {
    delay(50);
    forward();
  }
  ...
  else if (Ir1 == 0 && Ir2 == 0 && Ir3 == 0 && Ir4 == 0 && Ir5 == 0 && Ir6 == 0 && Ir7 == 1 && Ir8 == 1)
  {
    delay(150);
    hardleft();    
  }
  ...
  else if (Ir1 == 1 && Ir2 == 1 && Ir3 == 1 && Ir4 == 0 && Ir5 == 0 && Ir6 == 0 && Ir7 == 0 && Ir8 == 0)
  {
   ...
   else if (Ir1 == 1 && Ir2 == 1 && Ir3 == 0 && Ir4 == 0 && Ir5 == 0 && Ir6 == 0 && Ir7 == 0 && Ir8 == 0)
  {
    delay(100);
    hardright();    
  }
